"""
REPLICA 2 de la experimentacion, para validacion estadistica de la
...
Uso (identico a run_experiment.py):
    python run_experiment_2.py --max-llamadas 100
    python run_experiment_2.py --max-llamadas 100   # repetir hasta completar
    python run_experiment_2.py --configs H1_B0 --max-llamadas 100

Cuando quieras ver la tabla de esta replica: python build_results_table_2.py
"""
import argparse
...
RESULTADOS_FILE = "resultados_experimento_2.json"
